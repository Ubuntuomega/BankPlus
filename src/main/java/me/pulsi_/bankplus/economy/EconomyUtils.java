...
public class EconomyUtils {
    ...
    public static void savePlayer(OfflinePlayer p, boolean unload) {
        ...
        for (BPEconomy economy : BPEconomy.list()) {
            PlayerAccountData playerAccountData = new PlayerAccountData(economy.getOriginBank().getIdentifier(),
                    p.getUniqueId(),
                    p.getName(),
            ...
            BankPlus.INSTANCE().getDataManager().getPlayerController().updatePlayer(playerAccountData);
